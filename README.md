...
## ✨ v1.1.27 更新日志 (2026-02-11)

### 🆕 新增传感器
- **AHT20**: 高精度温湿度传感器 (±2% RH / ±0.3°C)
- **MPU9250**: 9轴运动传感器 (加速度计+陀螺仪+磁力计)
- **APDS-9960**: 数字环境光+RGB+手势传感器
- **VL6180**: 飞行时间测距传感器
- **BME680**: 4合1环境传感器 (温湿度+气压+气体)
- **RCWL-0516**: 微波雷达运动传感器 (5.8GHz)
